...
- **Cycles naturels**: La croissance de la végétation, la couverture de neige et l'étendue de l'eau sont toutes influencées par les saisons. Par exemple, les métriques NDVI pourraient être plus informatives pendant les saisons de croissance de pointe (@fig-ndvi-ts).  
...
![[EOS Data Analytics](https://eos.com/blog/satellite-time-series/) visualisation des séries chronologiques de l'indice de végétation de la différence normalisée (NDVI) montrant les tendances saisonnières.](https://eos.com/wp-content/uploads/2019/09/ndvi-time-series-main.jpg.webp){#fig-ndvi-ts}
...
[![Ouvrir Dans Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/center-for-effective-global-action-cega/MOSAIKS-Training-Manual/blob/main/notebooks/demo_fr/08-model_fews_net_demo.ipynb)  
