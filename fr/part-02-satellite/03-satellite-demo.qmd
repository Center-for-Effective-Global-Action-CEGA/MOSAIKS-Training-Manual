...
Cette démonstration vous montrera quelques concepts clés sur les données satellitaires et comment elles peuvent être préparées pour la vectorisation des caractéristiques (la vectorisation des caractéristiques est abordée dans @sec-features-computing).  
