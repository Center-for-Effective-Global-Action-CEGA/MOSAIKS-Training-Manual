...
## Quels sont les critères qui garantissent la qualité d’un jeu de données étiquetées  ?
...
| @sec-labels-demo       | Exemple pratique, flux de travail opérationnel, dépannage        |
