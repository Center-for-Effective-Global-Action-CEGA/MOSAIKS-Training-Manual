...
| Observation | District  | Année | Rendement agricole | Caractéristique 1 | Caractéristique 2 | ... |
|------------|-----------|------|--------------------|------------------|------------------|-----|
| 1          | Chibombo  | 2019 | 1.520             | 4.2              | 11.6             | ... |
| 2          | Kabwe     | 2019 | 1.878             | 2.9              | 5.3              | ... |
| ...        | ...       | ...  | ...               | ...              | ...              | ... |

: Exemple de données fusionnées avec étiquettes et caractéristiques. {#tbl-joined-data}

## Considérations de nettoyage des données

### Systèmes de coordonnées de référence (CRS)

MOSAIKS utilise le système **WGS 84** (EPSG:4326). Si vos données sont dans un autre système de coordonnées, elles doivent être reprojetées avant d’être fusionnées avec les caractéristiques MOSAIKS.

### Alignement temporel

Si vous travaillez avec des séries temporelles d’étiquettes, vous devrez générer des caractéristiques adaptées à chaque période.
