...
# Comprendre les features {#sec-features-rcf} 
...
![Maddy (Madagascar, au centre) prend des images satellites brutes (à gauche) et utilise la méthode du *kitchen sink* pour produire des features de convolution aléatoires (à droite). Art par [Grace Lewin](https://young-lab.eemb.ucsb.edu/people/grace-lewin).](../../images/Everything%20but%20the%20kitchen%20sink.gif){#fig-everything-but-the-kitchen-sink}
...
## Transformer des images en features
