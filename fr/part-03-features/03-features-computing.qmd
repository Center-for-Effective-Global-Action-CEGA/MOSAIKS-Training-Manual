...
# Calcul des features {#sec-features-computing} 
...
La bibliothèque [torchgeo](https://torchgeo.readthedocs.io/en/stable/) fournit une implémentation PyTorch des features de convolution aléatoires (RCF) :
