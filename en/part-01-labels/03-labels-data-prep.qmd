...
If you have time series labels, you will need to compute custom features for each time period. See @sec-features-computing for more information on how to do this and @sec-model-time for guidance on modeling time series data with MOSAIKS features.
