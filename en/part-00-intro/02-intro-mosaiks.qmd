...
1. Run a cross-validated ridge regression of your labels on the MOSAIKS features (**Y = Xβ + e**; or any other model you choose! See @sec-model-choice).
...
[Lecture slides.](../slides/en/MOSAIKS_Intro_TrainingDay1.pdf)
