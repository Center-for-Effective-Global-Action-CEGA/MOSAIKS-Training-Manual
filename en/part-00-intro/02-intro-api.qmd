...
This chapter explains how to access precomputed MOSAIKS features through an application programming interface (API). Our aim is to make these features as accessible as possible so that the majority of users do not have to worry about the technical details of satellite imagery processing, which is explained in later chapters.
