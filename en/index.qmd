...
(function() {
    ...
    document.addEventListener("DOMContentLoaded", checkAndHideContent);
    document.addEventListener("click", checkAndHideContent);
})();
</script>
...
| Part | Description |
|------|:------------|
| [Introduction](#sec-intro) | MOSAIKS overview, API access, computing setup, initial demonstration |
| [Label data](#sec-labels) | Understanding label data, data preparation |
| [Satellite imagery](#sec-sat-img) | Selecting appropriate imagery, processing considerations |
| [Satellite features](#sec-sat-features) | Random convolutional features, API access, feature computation |
| [Modeling](#sec-model) | Model selection, spatial analysis, temporal considerations |
| [Model evaluation](#sec-eval) | Uncertainty quantification, ethical considerations |
...
- Togo Data Lab ([TDL](https://datalab.gouv.tg/))
