...
::: {.callout-tip}
Please see the interactive RCF visualization tool at [mosaiks.shinyapps.io/rcf-visualizer/](https://mosaiks.shinyapps.io/rcf-visualizer/) to see how various convolutional parameters effect RCF.

Additionaly, there are many great resources for visualizing convolutions, including [Convolutional Neural Networks (CNNs) explained](https://poloclub.github.io/cnn-explainer/).
:::
